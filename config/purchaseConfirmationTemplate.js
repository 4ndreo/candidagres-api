...
export const purchaseConfirmationTemplate = (userData, purchaseData) => {
  return `
<html>
<head>
...
<body>
  ...
  <h1>¡Gracias por tu compra, ${userData.first_name ?? userData.email}!</h1>
  <p>Podés ver <a href='${process.env.FRONT_URL}/store/purchases/${userData._id}'>tus otras compras acá.</a></p>
  <div>
    <h2>Resumen</h2>
